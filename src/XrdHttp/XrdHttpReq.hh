...
public:
  ...
  * @param xrootdSelectedChecksum the checksum that will be performed
  */
  static void selectXRootDChecksum(const char * xrootdUserDigest, const std::string & userDigest, std::string & xrootdSelectedChecksum);
};
