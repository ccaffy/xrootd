    ...
    if (CurrentReq.opaque) {
      ...
      if (tk) {
        ...
        if (nfo) {
          ...
          SecEntity.name = decode_str<char *>(nfo);
        ...
        if (nfo) {
          ...
          SecEntity.host = decode_str<char *>(nfo);
        ...
        if (nfo) {
          ...
          SecEntity.moninfo = decode_str<char *>(nfo);
        ...
        if (nfo) {
          ...
          SecEntity.role = decode_str<char *>(nfo);
        ...
        if (nfo) {
          ...
          SecEntity.grps = decode_str<char *>(nfo);
        ...
        if (nfo) {
          ...
          SecEntity.endorsements = decode_str<char *>(nfo);
        ...
        if (SecEntity.credslen) {
          ...
          if (nfo) {
            ...
            SecEntity.creds = decode_str<char *>(nfo);
