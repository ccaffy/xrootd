...
public:
   ...
   * @param output the map containing the digest name and the associated preference
   */
  static void parseWantReprDigest(const std::string & value, std::map<std::string, ushort> & output);
};
