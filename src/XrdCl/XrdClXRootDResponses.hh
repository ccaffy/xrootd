...
namespace XrdCl
{
  ...
  //----------------------------------------------------------------------------
  //! Describe a data tract for vector preread
  //----------------------------------------------------------------------------
  class  File;
  ...
  struct TractInfo
  {
    ...
    TractInfo( uint64_t off = 0, uint32_t len = 0, File* fp = 0 ):
      offset( off ), length( len ), pFile( fp ) {}
    ...
    File*    pFile;  //! Future extension for multi-file preread, for now always 0
  };
  ...
  //! List of Tracts
  //----------------------------------------------------------------------------
  typedef std::vector<TractInfo> TractList;
